            ...
            <div className="backgroundColour">
                ...
                <Box direction="row" justify="center">
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:10}}>Listening</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:10}}>Speaking</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:20}}>Reading</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:15}}>Writing</Text>
                    </div>
                </Box>
                <br/>
                <br/>
