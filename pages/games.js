    ...
    return (
        <Grommet className="myTheme" >
            ...
            <div className="backgroundColour">
                ...
                <Box direction="row" justify="center">
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:33}}>FPS</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                            src="/LoL Logo.png"
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:25}}>MOBA</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:20}}>Raiding</Text>
                    </div>
                </Box>
                <br/>
                ...
                <Box direction="row" justify="center">
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:30}}>Tetris</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        <br/>
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify'}}>Mobile Gaming</Text>
                    </div>
                    <div style={{display: 'inline-block', marginLeft: 45, marginRight: 45, marginBottom: 20}}>
                        <Image
                        ...
                        />
                        <br/>
                        <Text style={{display: 'inline-block', textAlign: 'justify', paddingLeft:20}}>Other</Text>
                    </div>
                </Box>
